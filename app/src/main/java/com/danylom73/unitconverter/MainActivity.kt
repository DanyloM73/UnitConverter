package com.danylom73.unitconverter
...
import com.danylom73.unitconverter.ui.theme.UnitConverterTheme
...
fun UnitConverter(modifier: Modifier = Modifier) {
    ...
    fun convertUnits() {
        ...
        val result = (inputValueDouble * conversionFactor.doubleValue * 100.0 /
                outputConversionFactor.doubleValue).roundToInt() / 100.0
